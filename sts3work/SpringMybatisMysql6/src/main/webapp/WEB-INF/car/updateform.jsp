...
<input type="hidden" name="num" value="${dto.num }">
		...
		<table class="table table-bordered" style="width: 350px">
			...
			<tr>
				<th bgcolor="pink" width="100">자동차 색상</th>
				<td><input type="color" name="carcolor" size="10" value="${dto.carcolor }"></td>
			</tr>

			<tr>
				<th bgcolor="pink" width="100">자동차 구입일</th>
				<td><input type="date" name="carguip" size="10"
					value="${dto.carguip }"></td>
			</tr>
