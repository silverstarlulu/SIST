		...
		<table class="table table-bordered" style="width: 450px">
			...
			<tr>
				...
				<td><input type="text" name="writer"
					class="form-contorl" style="width: 300px;" value="${dto.writer }" readonly="readonly"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="subject" required="required"
					class="form-contorl" style="width: 300px;" value="${dto.subject }"></td>
			</tr>
			...
			<tr>
				...
				<td><textarea required="required" name="content"
						style="width: 300px; height: 200px;" class="form-contorl">${dto.content }</textarea></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button
						style="background-color: #FFABAB; border-color: #FFABAB;"
						type="submit" class="btn btn-info">글 수정</button>
					<button class="btn btn-info"
						style="background-color: white; color: #393646; border-color: #393646"
						type="button" onclick="location.href='/'">취소</button></td>
			</tr>
		</table>
