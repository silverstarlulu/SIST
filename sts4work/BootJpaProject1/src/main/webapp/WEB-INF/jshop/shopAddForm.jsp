	...
	<form action="insert" method="post">
		<table class="table table-bordered" style="width: 400px">
			...
			<tr>
				...
				<td><input type="text" name="sangpum" class="form-control"></td>
			</tr>
			<tr>
				<th width="150"
			...
			<tr>
				...
				<td>
					<select name="photo">
						<option value="포차코2.png">포차코</option>
						<option value="피짱즈.png">피짱즈</option>
						<option value="케로피2.png">케로피</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td><input type="date" name="ipgoday" value="2023-01-01"></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button type="submit"
						class="btn btn-warning">상품입고</button>
					<button type="button" class="btn btn-default"
						onclick="location.href='shopList'">목록</button></td>
			</tr>
		</table>
	</form>
</body>
