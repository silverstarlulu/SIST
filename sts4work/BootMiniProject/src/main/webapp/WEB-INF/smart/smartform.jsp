...
<form action="insert" method="post">
   <table class="table table-bordered" style="width: 800px; margin-left: 50px;">
      <caption style="caption-side: top;"><h3>스마트 상점 입고</h3></caption>
      <tr>
         <th bgcolor="#E1EEDD" width="100" style="text-align: center">상품명</th>
         <td>
      ...
      <tr>
         <th bgcolor="#E1EEDD" width="100" style="text-align: center">색상</th>
         <td>
      ...
      <tr>
         <th bgcolor="#E1EEDD" width="100" style="text-align: center">단가</th>
         <td>
      ...
      <tr>
         <th bgcolor="#E1EEDD" width="100" style="text-align: center">입고일</th>
         <td>
