	...
	<div style="margin: 0 auto; width: 90%" align="center">
		<c:if test="${count==0 }">
			...
			<button type="button" onclick="location.href='form'"
				class="btn btn-sm" style="background-color:#A9907E; color:white; margin-bottom: 20px; float: right">상품입고</button>
		</c:if>
		<c:if test="${count>0 }">
				...
				<c:forEach var="dto" varStatus="i" items="${list }">
					...
					<tr>
						<td align="center"><button type="button"
								class="btn btn-default btn-sm" style="background-color:#E1EEDD; color: #675D50; border: 1px solid #675D50"
								onclick="location.href='modify?num=${dto.num}'">수정</button>
							<button type="button" class="btn btn-default btn-sm" style="background-color:#E1EEDD; color: #675D50; border: 1px solid #675D50"
